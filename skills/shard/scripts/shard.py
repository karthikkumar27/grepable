#!/usr/bin/env python3
"""
shard.py - Split a large FSD/PRD markdown file into indexed section files.
...
Usage
  python shard.py SOURCE OUT_DIR [--level 2] [--max-lines 800]
...
def main():
    ...
    out = [
        "# Spec Index", "",
        f"> Generated by shard.py from `{src_label}`. Do not edit; change the source and re-run.",
